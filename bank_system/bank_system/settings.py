...
SECRET_KEY = 'django-insecure-thg=4vd!%!*%j-^o+tjxmhp1$fc*pb#g6rfg1d*+&dcqjob45@'
...
# Changing default user auth model to custom
...
PROXY_DOMAIN_URL = "http://tricky-geckos-guess.loca.lt"
